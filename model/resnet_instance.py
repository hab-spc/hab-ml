...
from lemniscate.lib.normalize import Normalize
...
def resnet10(low_dim=128):
    return ResNet(L.BasicResBlock, [1, 1, 1, 1],  [64, 128, 256, 512], [False, True, True, True], low_dim)

def resnet18(low_dim=128):
    return ResNet(L.BasicResBlock, [2, 2, 2, 2],  [64, 128, 256, 512], [False, True, True, True], low_dim)

def resnet34(low_dim=128):
    return ResNet(L.BasicResBlock, [3, 4, 6, 3],  [64, 128, 256, 512], [False, True, True, True], low_dim)

def resnet50(low_dim=128):
    return ResNet(L.BottleneckResBlock, [3, 4, 6, 3],  [64*4, 128*4, 256*4, 512*4], [False, True, True, True], low_dim)

def resnet10_dropout(low_dim=128):
    return ResNet(L.BasicResBlock, [1, 1, 1, 1],  [64, 128, 256, 512], [False, True, True, True], low_dim, dropout=True)

def resnet18_dropout(low_dim=128):
    return ResNet(L.BasicResBlock, [2, 2, 2, 2],  [64, 128, 256, 512], [False, True, True, True], low_dim, dropout=True)

def resnet34_dropout(low_dim=128):
    return ResNet(L.BasicResBlock, [3, 4, 6, 3],  [64, 128, 256, 512], [False, True, True, True], low_dim, dropout=True)

def resnet50_dropout(low_dim=128):
    return ResNet(L.BottleneckResBlock, [3, 4, 6, 3],  [64*4, 128*4, 256*4, 512*4], [False, True, True, True], low_dim, dropout=True)
"""END: ResNet model functions"""


def create_model(arch, low_dim=128):
    """ Create ResNet Model
